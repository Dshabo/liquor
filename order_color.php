...
<section class="content">
         <center>
         <hgroup>
                 <h2>Pick A Color of Car</h2>
         </hgroup>
         <article>
              <form class="form-wrapper cf" action="process.php" method="POST">
				<input type="text" name="color" placeholder="Search For A Color..." required autofocus>
